    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http, JwttokenFilter jwtTokenFilter) {
        ...
        return http
            ...
            .authorizeExchange((auth) -> 
                auth.pathMatchers("/healt", "/auth/login").permitAll()
                .pathMatchers("/usuarios/consultar/rol").hasAnyRole("ADMIN")
                .anyExchange().authenticated() // Permitimos el acceso sin autenticación al login
